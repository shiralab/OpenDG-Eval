...
class Ensemble_MMD_with_Dir_mixup(Algorithm):
    def __init__(self, args):
        super(Ensemble_MMD_with_Dir_mixup, self).__init__(args)
    ...
    def update(self, minibatches, opt, sch):
        ...
        for model_domain in range(nmb):
            ...
            penalty += self.mmd(z_model_domain_0, z_model_domain_1)
            penalty += self.mmd(z_model_domain_0, z_model_domain_2)
            penalty += self.mmd(z_model_domain_1, z_model_domain_2)
